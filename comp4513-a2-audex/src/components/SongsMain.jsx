      ...
      <div className="border-b border-white/5 px-8 py-4 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="bg-[#0a1628] border border-[#00e5ff]/20 text-[#ddeeff] text-xs tracking-widest px-3 py-1.5 focus:outline-none focus:border-[#00e5ff]/50 appearance-none cursor-pointer"
          >
