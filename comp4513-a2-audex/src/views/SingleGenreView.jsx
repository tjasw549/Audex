...
const SingleGenreView = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center overflow-x-hidden justify-center h-screen bg-[#060810]">
  ...
  return (
    <div className="bg-[#060810] overflow-x-hidden text-[#ddeeff] min-h-screen ">
      ...
      <div className="relative h-[300px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12 flex flex-col md:flex-row items-start md:items-end justify-between">
          {" "}
          <div>
